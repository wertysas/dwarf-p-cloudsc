...
#ifdef CLOUDSC_STD_PAR_SCC
USE CLOUDSC_DRIVER_STD_PAR_SCC_MOD, ONLY: CLOUDSC_DRIVER_STD_PAR_SCC
#endif

#ifdef CLOUDSC_STD_PAR_SCC_K_CACHING
USE CLOUDSC_DRIVER_STD_PAR_SCC_K_CACHING_MOD, ONLY: CLOUDSC_DRIVER_STD_PAR_SCC_K_CACHING
#endif
...
#ifdef CLOUDSC_STD_PAR_SCC
print '(1X,A46)', 'Executing CLOUDSC-STD-PAR, "SCC" variant...'

 ! Call the driver to perform the parallel loop over our kernel
CALL CLOUDSC_DRIVER_STD_PAR_SCC(NUMOMP, NPROMA, GLOBAL_STATE%KLEV, NGPTOT, GLOBAL_STATE%NBLOCKS, NGPTOTG, &
     & GLOBAL_STATE%KFLDX, GLOBAL_STATE%PTSPHY, &
     & GLOBAL_STATE%PT, GLOBAL_STATE%PQ, &
     & GLOBAL_STATE%B_CML,   GLOBAL_STATE%B_TMP, GLOBAL_STATE%B_LOC, &
     & GLOBAL_STATE%PVFA,    GLOBAL_STATE%PVFL,  GLOBAL_STATE%PVFI, &
...
#ifdef CLOUDSC_STD_PAR_SCC_K_CACHING
print '(1X,A60)', 'Executing CLOUDSC-STD-PAR, "SCC-K-CACHING" variant...'

 ! Call the driver to perform the parallel loop over our kernel
CALL CLOUDSC_DRIVER_STD_PAR_SCC_K_CACHING(NUMOMP, NPROMA, GLOBAL_STATE%KLEV, NGPTOT, NGPTOTG, GLOBAL_STATE%NBLOCKS, &
     & GLOBAL_STATE%KFLDX, GLOBAL_STATE%PTSPHY, &
     & GLOBAL_STATE%PT, GLOBAL_STATE%PQ, &
     & GLOBAL_STATE%TENDENCY_CML, GLOBAL_STATE%TENDENCY_TMP, GLOBAL_STATE%TENDENCY_LOC, &
     & GLOBAL_STATE%B_CML,   GLOBAL_STATE%B_TMP, GLOBAL_STATE%B_LOC, &
